...
WIDTH_PERCENT=30  # Width as percentage of screen width
HEIGHT_PERCENT=40 # Height as percentage of screen height
X_PERCENT=25      # X position as percentage from left (25% centers a 50% width window)
Y_PERCENT=15       # Y position as percentage from top
